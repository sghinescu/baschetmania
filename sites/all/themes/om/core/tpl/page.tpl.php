 ...
 *
 * Creating a Region 
 * - param: css region-id, variable name from .info, 1 or 0 for creating inner div
 * 
 * <?php print om_region('region-id', $region_name, 1); ?> 
 */
?>
<div class="wrapper-outer">
  ...
  <?php print om_region_wrapper('highlighted', render($page['highlighted']), 1); ?>
  <div id="container" class="wrapper"> <div id="container-inner" class="wrapper-inner">
    ...
    <?php print om_region_wrapper('sidebar-second', render($page['sidebar_second']), 1); ?>
    <div id="main">
